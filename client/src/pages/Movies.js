...
const Movies = () => {
  ...
  const fetchMovies = useCallback(async () => {
    ...
    try {
      const response = await contentAPI.discoverContent('movie', filters);
  ...
  return (
    <Layout>
      <SEOHead
        title="Movies - Stream Free HD Movies Online"
        description="Discover and stream thousands of free HD movies online. From blockbusters to indie films, watch your favorite movies without subscription."
        keywords="free movies, HD movies, streaming, watch online, blockbusters, cinema"
      />
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="mb-4 lg:mb-0">
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  Discover thousands of free HD movies
                </p>
              </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <p className="text-gray-600 dark:text-gray-400">
                  {pagination.totalResults && (
                    <>Showing {movies.length} of {pagination.totalResults.toLocaleString()} movies</>
                  )}
                </p>
